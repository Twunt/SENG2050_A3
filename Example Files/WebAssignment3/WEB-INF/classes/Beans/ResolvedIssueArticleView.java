...
@WebServlet(urlPatterns = {"/ResolvedArticle"})
public class ResolvedIssueArticleView extends HttpServlet {
    private int issueID;
    ...
    throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/ResolvedIssueArticleView.jsp");
