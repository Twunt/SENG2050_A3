...
=======
insert into userComment VALUES(1, "Rbille",1,"Try turning it off and back on again","2015-10-26 11:00:00");

--Network Entries 
insert into issue VALUES(1, "LGulliver","RBille","inProgress","My computer can't find any available networks","No Network Found","network","cantConnect","common room",false,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
insert into issue VALUES(2,"BPrattern",NULL,"new","wep pages load very slowly","slow internet","network","speed","common room",true,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
insert into issue VALUES(3, "NBrown","AFaulds","kBase","whilst loading web pages, my internet cuts out","dropouts loading web pages","network","dropouts","NS117",true,true,true,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
insert into issue VALUES(4, "CDodd","AFaulds","inProgress","on many web pages, random popups come up and disrupt my work","getting popups","network","other","CR043",true,true,false,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

--Software Entries
insert into issue VALUES(5, "NBrown","RBille","inProgress","It takes a long time to open any programs on my computer","Computer is running slowly","software","slowLoad","common room",NULL,NULL,NULL,NULL,"mac","MOS9.3.1","desktop","CR19","all","misc",NULL,NULL,NULL,NULL);
insert into issue VALUES(6, "BPrattern",NULL,"new","I can't open microsoft word","word won't open","software","wontLoad","common room",NULL,NULL,NULL,NULL,"pc","Windows 10","desktop","CR07","MS Word","2015",NULL,NULL,NULL,NULL);
insert into issue VALUES(7, "LGulliver","RBille","completed","Opening League of Legends opens DOTA2 as well. I DON'T WANT THIS","Running one program Opens another","software","other","LS043",NULL,NULL,NULL,NULL,"pc","Windows 7","laptop","Lewis PC","League of Legends","V4.21",NULL,NULL,NULL,NULL);

--Hardware Entries
insert into issue VALUES(8, "CDodd",NULL,"new","My computer won't start","dead computer","hardware","wontTurnOn","common room",NULL,NULL,NULL,"","","","","",NULL,NULL,NULL,NULL,NULL,NULL);
insert into issue VALUES(9, "CDodd","AFaulds","completed","my computer crashes whenever I run video games","computer crashes","hardware","blueScreens","common room",NULL,NULL,NULL,"","","","","",NULL,NULL,NULL,NULL,NULL,NULL);
insert into issue VALUES(10, "NBrown","AFaulds","kBase","my computer won't read CDs. I put the cd in the drive and it just doesnt recognise it","computer wont recognise CDs","hardware","diskDrive","NS107",NULL,NULL,NULL,"","","","","",NULL,NULL,NULL,NULL,NULL,NULL);
insert into issue VALUES(11, "BPrattern",NULL,"new","my headphones and microphone don't work. I plug them in but sound still plays through my monitor","headphones/microphone dont work","hardware","peripherals","NS247",NULL,NULL,NULL,"","","","","",NULL,NULL,NULL,NULL,NULL,NULL);
insert into issue VALUES(12, "LGulliver","RBille","resolved","my computer won't recognise my second hard drive. It's inserted into the port in the computer, but won't come up in My Computer","unrecognised hard drive","hardware","other","LS118",NULL,NULL,NULL,"","","","","",NULL,NULL,NULL,NULL,NULL,NULL);
>>>>>>> origin/master

--Email Entries 
insert into issue VALUES(13, "LGulliver","RBille","inProgress","an error pops up whenever i try to send an email","error on email send","email","cantSend",NULL,NULL,NULL,NULL,NULL,NULL,"",NULL,NULL,NULL,NULL,"","","",NULL);
insert into issue VALUES(14, "BPrattern",NULL,"new","my colleagues send me emails but I don't receive them. Nothing comes up in my inbox","not receiving emails","email","cantReceive",NULL,NULL,NULL,NULL,NULL,NULL,"",NULL,NULL,NULL,NULL,"","","",NULL);
insert into issue VALUES(15, "NBrown","RBille","kBase","I'm getting a lot of emails asking for my student username and password login","getting phishing emails","email","spamOrPhishing",NULL,NULL,NULL,NULL,NULL,NULL,"",NULL,NULL,NULL,NULL,"","","",NULL);
insert into issue VALUES(16, "NBrown","AFaulds","completed","Whenever I sign out of my email address, then try to sign back in, it always says my password is wrong when it is not","incorrect password when correct password entered","email","other",NULL,NULL,NULL,NULL,NULL,NULL,"",NULL,NULL,NULL,NULL,"","","",NULL);
...
=======
--Account Entries 
insert into issue VALUES(17, "CDodd","RBille","completed","whenever I try to log in, it says my password is incorrect when Im entering the same password I always use for this login","says password is incorrect when not","account","wrongDetails",NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,"user");
insert into issue VALUES(18, "BPrattern","AFaulds","inProgress","I've forgotten my password and need to reset it","forgotten password","account","passwordReset",NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,"user");
insert into issue VALUES(19, "LGulliver",NULL,"new","account says I am a user, when I should be an admin","wrong user status","account","other",NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,"user");
>>>>>>> origin/master
